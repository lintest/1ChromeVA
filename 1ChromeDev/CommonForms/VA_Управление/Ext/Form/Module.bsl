...
Функция ПолучитьСтрокуЗапуска(ИдентификаторКлиента)
	...
	Возврат "http://localhost/test/?N=Администратор&P=&L=ru&VL=ru&DisableStartupMessages&DisplayAllFunctions&EnableCheckModal&O=Normal&TESTCLIENT&TESTCLIENTID=" + ИдентификаторКлиента;
...
Процедура ВыполнитьJavaScript(ТекстJavaScript)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ВыполненJavaScript", ЭтотОбъект);
